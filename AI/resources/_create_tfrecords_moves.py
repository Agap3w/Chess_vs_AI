        ...
        if current_chunk:
            ...
            for x, y in all_pairs:
                if processed_pairs >= max_pairs:
                    break
                write_pair_to_tfrecord(writer, x, y)  # Write the (X, Y) pair
                processed_pairs += 1
...
if __name__ == "__main__":
    pgn_path = r"C:\Users\Matte\Desktop\temp chess\test zip.pgn.zst" # Your PGN file
    output_path = r"C:\Users\Matte\Desktop\temp chess\Train_Dataset"  # Output directory for TFRecords
    max_pairs = 999000  # Number of pairs to process (optional)
    shard_size = 1000000  # Number of pairs per shard (optional)
